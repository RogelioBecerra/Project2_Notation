...
public class MyStackTest {
	...
	Double num1 = 7.7, num2 = 8.8, num3= 9.9;
	...
	public void testPushStudent() {
		...
		try {
			...
			assertEquals(true, doubleS.push(3.3));
	...
	public void testToStringStudent() throws StackOverflowException {
		...
		assertEquals("7.78.89.9", doubleS.toString());
		doubleS.push(1.1);
		assertEquals("7.78.89.91.1", doubleS.toString());
		doubleS.push(2.2);
		assertEquals("7.78.89.91.12.2", doubleS.toString());
	}
